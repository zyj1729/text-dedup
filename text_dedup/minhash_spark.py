...
if __name__ == "__main__":  # pragma: no cover
    ...
    log.debug("Loaded documents: {}".format(DATA_SIZE))
    log.debug("args.input={}".format(args.input))
    log.debug("args.output={}".format(args.output))
    log.debug("args.threshold={}".format(args.threshold))
    log.debug("args.ngram_size={}".format(args.ngram_size))
    log.debug("args.min_length={}".format(args.min_length))
    log.debug("args.num_perm={}".format(args.num_perm))
    log.debug("args.column={}".format(args.column))
    ...
    if args.debug:
        aa = f"{args.output}-assignment/assignment.parquet"
        log.debug(f"Saving cluster to: {aa}")
